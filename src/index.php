...
<?php
$connection = new PDO('mysql:host=mysql;dbname=app;charset=utf8', 'root', 'root');
$query      = $connection->query("SELECT TABLE_NAME FROM information_schema.TABLES WHERE TABLE_SCHEMA = 'app'");
